...
public class TaskManager : MonoBehaviour
{
    ...
    public void OnSelectionEvent(GameObject selectedObject)
    {
        if (isTasking)
        {
            ...
            if (selectedObjectScript == null || selectedObjectScript.GetObjectName() != objectToSelectScript.GetObjectName())
            {
                ...
                Logtext.text += "," + currentTaskLog.GetErrorCount();
            }
            else
            {
    ...
    private void BeginNextSelectionTask()
    {
        ...
        Logtext.text = userId + "," + interactionType + "," + currentTaskLog.GetObjectName() + "," + currentTaskLog.GetStartTimestamp() + "," + currentTaskLog.GetEndTimestamp() + "," + currentTaskLog.GetErrorCount() + "\n";
